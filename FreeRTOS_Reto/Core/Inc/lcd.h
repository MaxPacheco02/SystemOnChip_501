...
#define LCD_RS_PIN_HIGH 0		                  //		Set pin RS_LCD
#define LCD_RS_PIN_LOW  16		                  //		Reset pin RS_LCD
#define LCD_RW_PIN_HIGH 2	                  //		Set pin RW_LCD
#define LCD_RW_PIN_LOW 	18	                  //		Reset pin RW_LCD
#define LCD_EN_PIN_HIGH 1	                  //		Set pin EN_LCD
#define LCD_EN_PIN_LOW 	17	                  //		Reset pin EN_LCD

#define LCD_D4_PIN_HIGH	5	                  //		Set pin DATA4_LCD
#define LCD_D5_PIN_HIGH 6	                  //		Set pin DATA5_LCD
#define LCD_D6_PIN_HIGH 8	                  //		Set pin DATA6_LCD
#define LCD_D7_PIN_HIGH 9	                  //		Set pin DATA7_LCD

#define LCD_D4_PIN_LOW 	21	                  //		Reset pin DATA4_LCD
#define LCD_D5_PIN_LOW 	22	                  //		Reset pin DATA5_LCD
#define LCD_D6_PIN_LOW 	24	                  //		Reset pin DATA6_LCD
#define LCD_D7_PIN_LOW 	25	                  //		Reset pin DATA7_LCD
/* *********************************************************************** */
